export default function Contact() {
  return (
    <div class="relative flex h-screen	w-screen flex-col items-center justify-center bg-slate-800 text-white">
      ...
      <div className="mb-10 text-xl font-mono"><span className="font-bold">Phone: </span>0422 019 884</div>
    </div>
  );
}
